...
struct EmojiManager {
    ...
    func showEmoji(content: String, font: UIFont) -> NSMutableAttributedString {
        ...
        //                print("----\(userName)")
        //                let attachmentUsername = NSMutableAttributedString(string: userName)
        //                attachmentUsername.setAttributes([.foregroundColor: UIColor.blueFontColor()], range: NSRange(location: 0, length: attachmentUsername.length))
        //                attributedString.replaceCharacters(in: result.range, with: attachmentUsername)
        //            }
        //        }
        //
        //
